        ...
        <div class="pull-left">
			<div class="row">
				...
				<div>
					...
					<a class="btn btn-success btn-sm" style="display: block;  width: 20%; position: absolute; left: 40%; right: 40%; background-color: green" href="{{ route('students.create') }}">Create New Student Data</a>
					</div>
				</div>
            </div>
